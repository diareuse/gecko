...
internal class ByteDataNetworkMetadataAdapter(
    private val metadata: NetworkMetadata
) : ByteData() {
...
fun NetworkMetadata.asByteData(): ByteData {
    return ByteDataNetworkMetadataAdapter(this)
}